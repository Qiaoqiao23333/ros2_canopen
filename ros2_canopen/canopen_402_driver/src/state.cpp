...
State402::InternalState State402::read(uint16_t sw)
{
  ...
  switch (state)
  {
    ...
    // Some drives report the QuickStop bit differently. Accept both q=0 and q=1
    // variants for the normal CiA402 states.
    case (0 | q | 0 | 0 | 0 | r):
    case (0 | 0 | 0 | 0 | 0 | r):
    ...
    // If the QuickStop bit is cleared while operation enabled, treat as quick stop active.
    case (0 | 0 | 0 | o | s | r):
